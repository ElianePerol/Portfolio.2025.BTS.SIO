            ...
            <div class="modal-body">
                ...
                <div class="portfolio-modal-table">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <span class="">
                                <a href="assets/docs/projects/welcome_training_extraits_code_commentes.pdf" target="_blank"><i class="fa-solid fa-arrow-up-right-from-square"></i>   Extraits de code commentés</a>
                            </span>
                        </div>
                        <div class="col-md-6">
                            <span class="">
                        ...
                        <div class="col-md-6">
                            <span class="">
                                <a href="assets/docs/projects/welcome_training_test.pdf" target="_blank"><i class="fa-solid fa-arrow-up-right-from-square"></i>   Plan de test qualité</a>
                            </span>
                        </div>
                        <div class="col-md-6">
                            <span class="">
                        ...
                        <div class="col-md-6">
                            <span class="">
                                <a href="assets/docs/projects/welcome_training_documentation_utilisateur.pdf" target="_blank"><i class="fa-solid fa-arrow-up-right-from-square"></i>   Documentation utilisateur</a>
                            </span>
                        </div>
                    </div>
                </div>
