                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bostami-page-title-wrap mb-40">
                            <h2 class="page-title">Synthèse</h2>
                ...
                <div class="row"> -->
                    ...
                    <!-- <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="bostami-section-title-wrap mb-20">
                            <h4 class="section-title"><i class="fa-light fa-school"></i>Nom</h4>
                        </div>

                        <div class="bostami-card-wrap mb-50">
                    ...
                    <!-- <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="bostami-section-title-wrap mb-20">
                            <h4 class="section-title"><i class="fa-light fa-briefcase"></i>Compétences</h4>
                        </div>
                    ...
                    <!-- sous-competence-start -->
                    <!-- <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="bostami-section-title-wrap mb-20">
                            <h4 class="section-title"><i class="fa-light fa-award"></i>Sous-Compétences</h4>
                        </div>
