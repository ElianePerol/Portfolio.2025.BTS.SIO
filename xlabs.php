        ...
        <div class="bostami-page-wrap pt-60 pl-80 pr-80">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bostami-page-title-wrap mb-40">
                            <h2 class="page-title">Entreprise</h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-8">
                        <div class="bostami-parsonal-info-img">
                            <img src="assets/img/presentation/xlabs.jpg" alt="">
                        </div>
                    </div>
                    ...
                    <div class="about-me-2-wrap">
                        <div class="bostami-parsonal-info-contact">
                            <div class="row">
                                <h3 class="title">Chiffres clés</h3>
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="bostami-parsonal-info-contact-item phone">
                                        ...
                                        <div class="text">
                                            <span>Plateaux techniques (en 2024)</span>
                                            <p>4</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-4">
                                    <div class="bostami-parsonal-info-contact-item email">
                                        ...
                                        <div class="text">
                                            <span>Sites de prélèvement (en 2024)</span>
                                            <p>18</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4 col-md-4">
                                    <div class="bostami-parsonal-info-contact-item email">
                                        ...
                                        <div class="text">
                                            <span>Départements implantés (en 2024)</span>
                                            <p>6</p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="what-i-do-2 mb-50">
                <div class="row">
                    ...
                    <!-- project -->
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="bostami-what-do-item bg-yellow">
                            <div class="icon">
                    ...
                    <!-- information -->
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="bostami-what-do-item bg-rose">
                            <div class="icon">
